<x-admin-layout title="Gestión de Clientes | Diagramas" :breadcrumbs="[['name' => 'Dashboard', 'href' => route('dashboard')], ['name' => 'Gestión de Clientes']]">
    ...
    <div class="space-y-5">
        ...
        <div class="flex items-center justify-between gap-4 flex-wrap">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Administra Clientes</p>
            </div>
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('admin.clients.index') }}"
                    class="inline-flex items-center gap-1.5 px-3 py-2 text-xl font-medium
                          text-white bg-blue-500 hover:bg-gray-50 hover:text-gray-950 border border-gray-200 rounded-lg transition">
                    <i class="ri-building-line text-xl"></i> Clientes
                </a>
            </div>
        </div>
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            @forelse($clients as $client)
                <a href="{{ route('admin.clients.manage.show', $client) }}"
                    ...
                    <div
                        class="w-11 h-11 rounded-xl bg-indigo-50 group-hover:bg-indigo-100
                    ...
                    <i
                        class="ri-arrow-right-s-line text-gray-300 group-hover:text-indigo-400 mt-1 shrink-0 transition"></i>
                </a>
            @empty
