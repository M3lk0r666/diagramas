<x-admin-layout title="Vista Isométrica · {{ $client->name }} | Diagramas" :breadcrumbs="[]">
    ...
    <div id="iso-wrapper"
        ...
        {{-- Label overlay: sin overflow-hidden para que no corten labels de los bordes --}}
        <div id="iso-labels" class="absolute inset-0 pointer-events-none"></div>

        {{-- Tooltip (posición fixed para no depender del canvas) --}}
