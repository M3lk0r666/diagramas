<x-admin-layout title="Mapeo de Puertos | Diagramas" :breadcrumbs="[
    ...
    <style>
        ...
        .jack.candidate {
            box-shadow: 0 0 0 2px #e0a83c;
        }

        /* SFP + estado: reglas explícitas para ganar sin ambigüedad de especificidad */
        .jack.sfp.active {
            background: #b5dd8f;
            border-color: #7fb84e;
            color: #3d6320;
                ...
                <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="legend">
                                <span><span class="dot" style="background:#e8e9eb;border-color:#c4c7cc"></span> Sin
                                    definir</span>
                                <span><span class="dot" style="background:#b5dd8f;border-color:#7fb84e"></span>
                                    Activo
                                    (se
                                    mantiene)</span>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Si un puerto cambia de posición, selecciona la opción <strong>Re-asignar</strong> y
                                elige el
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Revisa el diagrama para confirmar que las conexiones y re-asignaciones sean correctas
                                antes
                                de la migración.
                            </p>
                        </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Exporta el proyecto en formato <strong>JSON</strong> para continuar posteriormente o
                                carga
        ...
        <div id="pm-confirm-modal"
            ...
            <div class="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full mx-4">
                <div class="flex items-start gap-3 mb-4">
                    <span
                        class="flex-shrink-0 w-9 h-9 flex items-center justify-center rounded-full bg-amber-100 text-amber-600">
