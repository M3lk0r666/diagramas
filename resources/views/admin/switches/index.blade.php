                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    @if ($sw->parse_status === 'ok')
                                        <span
                                            class="inline-block bg-green-100 text-green-700 text-xs font-medium px-2 py-0.5 rounded-full">OK</span>
                                    @else
                                        <span
                                            class="inline-block bg-red-100 text-red-700 text-xs font-medium px-2 py-0.5 rounded-full"
                                ...
                                <td class="px-4 py-3 text-center">
                                    <form method="POST" action="{{ route('admin.switches.destroy', $sw) }}"
                                        ...
                                        @csrf @method('DELETE')
                                        <button type="submit" title="Eliminar switch"
